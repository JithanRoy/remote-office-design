    ...
    <section className="bg-primary text-white w-full h-full py-[6rem]">
      ...
      <div className='container mx-auto w-full'>
        <div className="flex flex-col gap-16">
          <div className="sticky top-[5.3rem] bg-primary py-4 z-50">
        ...
        <div className='flex flex-row justify-between items-center gap-16 my-20'>
          <div className="lg:w-1/2 w-1/2 flex flex-col gap-6">
            <h3 className="text-[2.5rem] font-bold">
            ...
            <p className="text-gray-400">
              ...
              We use comprehensive and rigorous criteria to evaluate their
              skills, experience, and fit for your business. We ensure that
              only the best talents make it to the next stage.
            </p>
            <a
              href="#"
              className="text-white font-semibold flex items-center gap-2 hover:underline no-underline"
        ...
        <div className='flex flex-row justify-between items-center gap-16 my-20'>
          <div className="lg:w-1/2 w-1/2 flex flex-col gap-6">
            ...
            <p className="text-gray-400">
              Our platform allows the candidates to showcase their skills and personality conveniently and flexibly. We
              then evaluate their performance both by our hiring team and by you. This ensures that you only meet with
              candidates who match your preferences and expectations.
            </p>
            <a
              href="#"
              className="text-white font-semibold flex items-center gap-2 hover:underline no-underline"
        ...
        <div className='flex flex-row justify-between items-center gap-16 mt-[150px]'>
          <div className="lg:w-1/2 w-1/2 flex flex-col gap-10">
            <h3 className="text-[2.5rem] font-bold">
              Technical challenge
            </h3>
            <p className="text-gray-400">
              We assist you in conducting the technical test through our outlined discipline. We co-create a tailored
              challenge relevant to the skills you need. Our platform allows the candidates to complete the challenge in
              a realistic and interactive environment. This allows you to review the code quality, logic, and efficiency
              of the candidates.
            </p>
            <a
              href="#"
        ...
        <div className='flex flex-row justify-between items-center gap-16 mt-[150px]'>
          <div className="lg:w-1/2 w-1/2 flex flex-col gap-10">
            ...
            <p className="text-gray-400">
              Our platform encapsulates all the data and feedback from the previous stages, so you can easily compare
              and evaluate the candidates. You only go for a face-to-face interview with the candidates that you feel
              have met all the criteria so far. This contributes to hiring the right fit at the right time.
            </p>
            <a
              href="#"
              className="text-white font-semibold flex items-center gap-2 hover:underline no-underline"
